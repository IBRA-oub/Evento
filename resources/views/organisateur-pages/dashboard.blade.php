...
{{-- _______________cards_________________ --}}
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-2 gap-6 px-4 py-8">
        ...
        <div
            ...
            <div class="flex gap-2 items-center">
                <span class="font-bold text-4xl">{{$statistiqueEventRefused}}</span>
            ...
            <span class="font-semibold opacity-70 text-sm text-center">Event Refused</span>
        </div>
    
        <div
            class="flex flex-col justify-center items-center gap-2 border border-dashed border-gray-500 p-4 rounded-md h-32">
            <div class="flex gap-2 items-center">
                <span class="font-bold text-4xl">{{$statistiqueEventAccepetd}}</span>
                <svg class="w-8 h-8 opacity-70" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                    stroke-width="1.5" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <div
            class="flex flex-col justify-center items-center gap-2 border border-dashed border-gray-500 p-4 rounded-md h-32 ml-9">
            <div class="flex gap-2 items-center">
                <span class="font-bold text-4xl">{{$statistiqueReservationAccepted}}</span>
                <svg class="w-8 h-8 opacity-70" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                    stroke-width="1.5" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <span class="font-semibold opacity-70 text-sm text-center">Reservation Accepted</span>
        </div>
        ...
        <div
            ...
            <div class="flex gap-2 items-center">
                <span class="font-bold text-4xl">{{$statistiqueReservationPending}}</span>
...
{{-- _________________cards end___________________ --}}
@endsection